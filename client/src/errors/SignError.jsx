    ...
    return ReactDom.createPortal(
        <>
            ...
            <div className="w-[40%]  bg-white rounded-md p-6 fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] z-30 space-y-2">
                <div>
                    <h3 className="text-center text-2xl font-semibold"><span className="text-red-500">Failed</span> to signup!</h3>
                ...
                <div className="flex justify-center">
                    <button className="bg-teal-700 py-1 px-4 text-white font-semibold rounded-md active:scale-[0.9] " onClick={closeModal}>Try Again</button>
                </div>
            </div>
        </>,
